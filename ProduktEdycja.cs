    ...
    public partial class ProduktEdycja : Form
    {
       ...
       sprawdz_poprawnosc();
            ...
            if (poprawne == true)
            {
                ...
                OleDbCommand laczenie = new OleDbCommand();
                laczenie.Connection = con;
                string queryDodaj = "insert into Produkty(KodProduktu, NazwaProduktu, Opis, CenaJednostkowa, Ilosc) values('" + kod_prod.Text + "','" + nazwa_prod.Text + "','" + opis_prod.Text + "','" + koszt_prod.Text + "','" + ilosc_prod.Text + "')";
